  ...
  const items = [
    {
      ...
      bgImg: `url(${require("../assets/images/webp/learnus1.webp")})`,
    },
    {
      id: 2,
      heading: "lead-gen",
      ...
      bgImg: `url(${require("../assets/images/webp/learnus2.webp")})`,
    },
    {
      id: 3,
      heading: "ecommerce",
      ...
      bgImg: `url(${require("../assets/images/webp/learnus3.webp")})`,
    },
  ];
  return (
    <>
      <div className="my-5 pt-xl-5 pt-3 text-center">
        <h2
          className="ff_sohne_schmal_bold fs_xxl fw_bold lh_87 text-uppercase text-center text-black mb-2 pb-1"
          data-aos="zoom-in-up"
        ...
        <p
          className="ff_space_mono fw-light fs_5sm text-black lh_134 text-center mb-4 pb-2"
          data-aos="zoom-in-up"
          data-aos-easing="linear"
        ...
        <button
          className="bg-transparent border-0 ff_maison_neue_medium fw-semibold fs_5sm text-black lh_134 text-capitalize"
          data-aos="zoom-in-up"
          data-aos-easing="linear"
      ...
      <Row
        className="max_w_1440 mx-auto gap-xl-0 gap-lg-5  gap-3 justify-content-center mb-5"
        data-aos="zoom-in-up"
        data-aos-easing="linear"
        data-aos-duration="1200"
      >
        {items.map((x) => (
          <Col xs={11} sm={9} xl={4} lg={5} md={7} key={x.id} data={x}>
            <div
